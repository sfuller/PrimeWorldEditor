...
protected:
    TSerializeableTypedProperty(EGame Game)
        : TTypedProperty<PropType, PropEnum>(Game)
    {}
...
public:
    virtual void Serialize(IArchive& rArc)
    {
        ...
        TSerializeableTypedProperty* pArchetype = static_cast<TSerializeableTypedProperty*>(IProperty::mpArchetype);
        ...
        if (IProperty::Game() <= EGame::Prime || pArchetype != nullptr)
        {
            MakeOptional = true;
        }
        else
        ...
        if (MakeOptional)
            rArc << SerialParameter("DefaultValue", TTypedProperty<PropType, PropEnum>::mDefaultValue, SH_Optional, pArchetype ? pArchetype->mDefaultValue : GetSerializationDefaultValue());
        else
            rArc << SerialParameter("DefaultValue", TTypedProperty<PropType, PropEnum>::mDefaultValue);
    }

    virtual bool ShouldSerialize() const
    {
        auto *pArchetype = static_cast<TTypedProperty<PropType, PropEnum>*>(IProperty::mpArchetype);

        return TTypedProperty<PropType, PropEnum>::ShouldSerialize() ||
                !(TTypedProperty<PropType, PropEnum>::mDefaultValue == pArchetype->DefaultValue());
    }
...
public:
    virtual void Serialize(IArchive& rArc)
    {
        ...
        TNumericalProperty* pArchetype = static_cast<TNumericalProperty*>(IProperty::mpArchetype);
    ...
    virtual void PropertyValueChanged(void* pPropertyData)
    {
        ...
        {
            PropType& rValue = TTypedProperty<PropType, PropEnum>::ValueRef(pPropertyData);
